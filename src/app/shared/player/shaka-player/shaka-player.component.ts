...
export class ShakaPlayerComponent implements AfterViewInit {
  ...
  private initPlayer() {
    ...
    let videoUrl = "https://demo.unified-streaming.com/k8s/features/stable/video/tears-of-steel/tears-of-steel.ism/.mpd";
    //http://localhost:5050/CDSContents/pdf/video.mp4
  //http://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ElephantsDream.mp4
  //https://demo.unified-streaming.com/k8s/features/stable/video/tears-of-steel/tears-of-steel.ism/.mpd -> MPEG
  //https://test-streams.mux.dev/x36xhzz/x36xhzz.m3u8 -HLS
 // https://bitdash-a.akamaihd.net/content/sintel/hls/playlist.m3u8 ->HLS
    if (this.platform.SAFARI) {
